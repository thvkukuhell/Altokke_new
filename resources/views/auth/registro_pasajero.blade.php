...
<main>
    <img src="{{ asset('img/login_client_icon.png') }}" alt="Imagen pasajero" id="img-pasajero">

    <form action="{{ route('proc_regist_pasajero') }}" method="POST" class="registro-pasajero" autocomplete="on"
        novalidate>
        ...
        <div class="inputs">
            ...
            <input required type="text" name="dni" minlength="8" placeholder="DNI" value="{{ old('dni') }}">

            <input required type="text" name="telefono" placeholder="Teléfono" value="{{ old('telefono') }}">

            <input required type="email" name="email" id="email" placeholder="ejemplo@dominio.com"
                value="{{ old('email') }}">
