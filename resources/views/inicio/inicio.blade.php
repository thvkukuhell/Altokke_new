  ...
  <div class="seccion-inner">
    <div class="sobre-grid">
      <div class="sobre-texto reveal">
        ...
        <p>Somos estudiantes de la <strong>Universidad Nacional Toribio Rodríguez de Mendoza</strong> que vimos el caos del transporte en nuestra ciudad y decidimos resolverlo con tecnología.</p>
        <p>Altokke conecta pasajeros con conductores de forma transparente — con tarifas claras, conductores verificados y sin intermediarios.</p>
...
<section class="cta-final">
  ...
  <div class="cta-inner reveal">
    <span class="seccion-chip seccion-chip-claro" style="margin-bottom:20px; display:inline-block;">Empieza ahora</span>
